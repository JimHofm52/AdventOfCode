...
public class Day12 {
    ...
    public static void update() throws IOException {
        ...
        String dirIn[] = ReadWriteFiles.getInputStr(fileNum);// Get input in an array for 12(121)
        ...
        // ----- Part 2 ------
        dirIn = ReadWriteFiles.getInputStr(fileNum); // Get input in an array for 12(121)
